...
function showThemes(data, textStatus, jqXHR) {
	...
	/*
	function downloadThemes(categories){ 
		let themesElems = document.querySelectorAll('#' + categories + ' > img');
	...
	$('#downloadNature').on('click', function(){downloadThemes('Nature')});
	$('#downloadSpace').on('click', function(){downloadThemes('Space')});
	$('#downloadCute').on('click', function(){downloadThemes('Cute')});*/
}
