...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2017 a las 00:58:02
...
(1, 'media/img/holis0.jpg', 36),
(1, 'media/img/holis1.jpg', 37),
(1, 'media/img/holis2.jpg', 38);
...
--
ALTER TABLE `imagenes_relacionadas`
  MODIFY `id_img_relac` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
--
